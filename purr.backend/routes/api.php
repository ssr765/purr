...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum'])->group(function () {
        ...
        Route::prefix('cats')->name('cats.')->group(function () {
            ...
            Route::post('/{cat}/avatar', [V1CatController::class, 'updateAvatar'])->name('avatar.update');
            Route::delete('/{cat}/avatar', [V1CatController::class, 'deleteAvatar'])->name('avatar.delete');
    ...
    Route::prefix('cats')->name('cats.')->group(function () {
        ...
        Route::get('/{cat}/posts', [V1CatController::class, 'posts'])->name('posts');
    });
