...
<template>
  <aside class="h-dvh overflow-auto">
    <div class="flex flex-col items-center justify-center w-full gap-16 p-16">
      ...
      <form @submit.prevent="register()" class="max-w-sm w-full mx-auto space-y-8">
        <div class="space-y-4">
          <div class="relative z-0 w-full group">
            ...
            <label for="register_name" class="peer-focus:font-medium absolute text-sm text-ctp-text duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-ctp-lavender peer-focus:dark:text-ctp-lavender peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">{{ $t('auth.register.name') }} </label>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <label for="register_username" class="peer-focus:font-medium absolute text-sm text-ctp-text duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-ctp-lavender peer-focus:dark:text-ctp-lavender peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">{{ $t('auth.register.username') }} </label>
            <p class="text-xs text-ctp-text mt-2">{{ $t('auth.register.usernameHelp') }}</p>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <label for="register_email" class="peer-focus:font-medium absolute text-sm text-ctp-text duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-ctp-lavender peer-focus:dark:text-ctp-lavender peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">{{ $t('auth.register.email') }} </label>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <label for="register_password" class="peer-focus:font-medium absolute text-sm text-ctp-text duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-ctp-lavender peer-focus:dark:text-ctp-lavender peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">{{ $t('auth.register.password') }} </label>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <label for="register_repeat_password" class="peer-focus:font-medium absolute text-sm text-ctp-text duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-ctp-lavender peer-focus:dark:text-ctp-lavender peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">{{ $t('auth.register.passwordConfirmation') }} </label>
          </div>
        </div>
