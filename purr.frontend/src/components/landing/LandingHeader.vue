      ...
      <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        ...
        <div class="bg-ctp-crust lg:bg-transparent hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1 absolute top-[60px] left-0 lg:static" id="mobile-menu-2">
          <ul class="flex flex-col pt-3.5 pb-3 px-5 lg:p-0 font-medium lg:flex-row lg:space-x-8 lg:mt-0 divide-y-2 divide-ctp-lavender/50 lg:divide-y-0">
            <li>
              <RouterLink to="/" exactActiveClass="text-black dark:text-white" class="block py-2 pr-4 pl-3 hover:bg-ctp-lavender/35 lg:bg-transparent lg:p-0" aria-current="page">Home</RouterLink>
            </li>
            <li>
              <RouterLink to="/features" exactActiveClass="text-black dark:text-white" class="block py-2 pr-4 pl-3 hover:bg-ctp-lavender/35 lg:hover:bg-transparent lg:border-0 lg:p-0">Características</RouterLink>
            </li>
            <li>
              <RouterLink to="/ai" exactActiveClass="text-black dark:text-white" class="block py-2 pr-4 pl-3 hover:bg-ctp-lavender/35 lg:hover:bg-transparent lg:border-0 lg:p-0">AI</RouterLink>
            </li>
            <li>
              <RouterLink to="/faqs" exactActiveClass="text-black dark:text-white" class="block py-2 pr-4 pl-3 hover:bg-ctp-lavender/35 lg:hover:bg-transparent lg:border-0 lg:p-0">FAQs</RouterLink>
            </li>
            <li>
              <RouterLink to="/tecnologies" exactActiveClass="text-black dark:text-white" class="block py-2 pr-4 pl-3 hover:bg-ctp-lavender/35 lg:hover:bg-transparent lg:border-0 lg:p-0">Tecnologias</RouterLink>
            </li>
          </ul>
        </div>
      </div>
