...
<template>
  <section class="h-app p-16">
    <label for="cat-content-input" class="h-full border-8 border-ctp-lavender border-dashed rounded-3xl flex flex-col items-center justify-center gap-2 p-4 hover:bg-ctp-lavender/20 cursor-pointer">
      ...
      <div class="xl:ml-5 text-center text-4xl lg:text-6xl tracking-tight font-bold leading-none">Comparte un momento felino</div>
      <div class="text-xl lg:text-3xl text-center">{{ $t('app.create.mediaInput.content') }}</div>
