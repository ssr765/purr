...
<template>
  <div class="antialiased bg-ctp-base">
    <div class="bg-ctp-crust flex md:hidden relative py-2">
      <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="absolute inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
        <span class="sr-only">Open sidebar</span>
        <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path clip-rule="evenodd" fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
        </svg>
      </button>
      <img src="/public/img/logo/light.webp" class="mx-auto hidden dark:block h-14" alt="purr. Logo" />
      <img src="/public/img/logo/dark.webp" class="mx-auto block dark:hidden h-14" alt="purr. Logo" />
    </div>

    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full bg-ctp-crust border-r border-ctp-lavender md:translate-x-0" aria-label="Sidenav">
      <div class="overflow-y-auto py-5 px-3 h-full">
        <div class="mb-5 mt-2">
          <a href="#" class="flex justify-center items-center text-2xl font-semibold text-gray-900 dark:text-white flex-col gap-2">
            <img src="/public/img/logo/light.webp" class="hidden dark:block h-20" alt="purr. Logo" />
      ...
      <div class="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-ctp-crust z-20">
    ...
    <main class="p-4 md:ml-64 min-h-dvh">
      <slot />
    </main>
  </div>
</template>
